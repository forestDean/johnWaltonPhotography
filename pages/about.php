...
<?php require_once (__DIR__ . '/assets/includes/slideshowAbout.html')?>
...
<div class="container">
  <div id="main">
    ...
    <div id="galleryHome">
		...
		<?php require_once (__DIR__ . '/../assets/images/aboutSlides.php')?>
        </div><!--end of #slideshowHome-->
    </div><!--end of #galleryHome-->
    
    <?php require_once (__DIR__ . '/../assets/includes/aboutText.html')?>
