...
$DEF_ALERT = "webmanager@btinternet.com";
...
$TEMPLATEURL = "https://www.johnwalton.photography/forms"; /* default; no template URL */
...
$FORM_INI_FILE = "/home/bsensual/private_formmail/formmail_JohnWalton.ini";
...
$ATTACK_DETECTION_JUNK_TRIGGER           = 1;
...
function LoadBuiltinLanguage()
{
	...
	$aMessages[MSG_ATTACK_PAGE] = 'Your form submission has been rejected... $USERINFO'.'<br /><br />';
	...
	// Parameters:
	//  none
	$aMessages[MSG_USER_ATTACK_MANY_URLS] = 'Please re-submit the form without URLs';
