...
<title>John Walton | Preview</title>
...
echo '<li id="thumb"><a href="../'.$folder.'/'.basename($image).'" class="gallery" rel="'.$folder.'" id="'.$folder.'" ><img src="thumbfull/'.basename($image).'" width="150" height="150"></a><div id="title">'.$ref.'<br><div id="delete"><a href="delete.php?action=delete&filename='.basename($image).'">delete file</a></div>';
//echo $height ;
if ($height !=450)
