...
$imagick->resizeImage(0, 450, Imagick::FILTER_LANCZOS,0.9,false);
...
if ($width == $height){
$imagick->resizeImage(125, 125, Imagick::FILTER_LANCZOS,0.7,true);
}else{
$imagick->resizeImage(255, 125, Imagick::FILTER_LANCZOS,0.7,false);
}
