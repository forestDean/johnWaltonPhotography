...
<title>JohnWalton | Process</title>

<link rel="stylesheet" href="autoloader.css" type="text/css" media="screen" >

<!-- BOF FANCYBOX  v2 -->
<script type="text/javascript" src="../../../jquery/fancybox/jquery.min.js"></script>
...
<link rel="stylesheet" href="../../../jquery/fancybox/jquery.fancybox.css?v=2.0.3" type="text/css" media="screen" >
<script type="text/javascript" src="../../../jquery/fancybox/jquery.fancybox.pack.js?v=2.0.3"></script>

<script type="text/javascript" src="../../../jquery/fancybox/autoloader.js"></script>
...
$imagick->writeImage("../tagged/" . $value);
...
# write the image to file.
$imagick->writeImage("../watermark/" . $value);
...
// display on page
echo '<li id="thumb"><a href="../tagged/'.$value.'" class="gallery" rel="tagged" id="'.$folder.'" ><img src="../thumbfull/'.$value.'" width="150" height="150"></a><div id="title">'.$value.'</div></li>' ;
}
# Free resources associated with the Imagick object
//$imagick->clear();
//$imagick->destroy();
