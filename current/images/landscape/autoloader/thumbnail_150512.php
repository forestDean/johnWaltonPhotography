...
echo '<li id="thumb"><a href="../'.$folder.'/'.basename($image).'" class="gallery" rel="'.$folder.'" id="'.$folder.'" width="'.$width.'" height="'.$height.'"><img src="../thumbs/'.basename($image).'" width="'.$width.'" height="'.$height.'"></a><div id="title">'.$ref.'</div></li>' ;
}
?>
</ul>
