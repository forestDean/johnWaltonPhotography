...
// extract Caption = ImageDescription from EXIF for landscape images only
//if ($width > $height){
//$exifArray = $im->getImageProperties("exif:*");
$exifArray = $imagick->getImageProperties("exif:ImageDescription");
$ref2 = $exifArray['exif:ImageDescription'];
//echo $ref2; exit;
