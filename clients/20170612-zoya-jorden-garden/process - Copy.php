...
$imagick->annotateImage($draw, 9, 14, 0, "john walton");
#text
$draw->setFillColor("white");
$draw->setFillAlpha(1); 
$draw->setFontSize(24);
...
//$draw->setGravity (Imagick::GRAVITY_CENTER);
$draw->setGravity (Imagick::GRAVITY_SOUTHEAST);
$imagick->annotateImage($draw, 10, 15, 0, "john walton");
# get ID number
...
#display on page
#extract everything after the literal "john walton_"
preg_match("/john walton_(.*)/", $image, $results);
