...
<?php } else { ?>    
      ...
      <div id="formContact">
        <form action="http://johnwalton.photography/forms/formmail_johnwalton.php" method="POST" name="form1"  class="f1">
          ...
          <input type=hidden name="good_url" value="http://johnwalton.photography/2015/contact.php?post=success">
          <div>name*</div>
